...
macro_rules! configure_app {
    ($builder:expr) => {
        $builder.invoke_handler(tauri::generate_handler![
            ...
            crate::runtime::window::is_main_window_visible,
