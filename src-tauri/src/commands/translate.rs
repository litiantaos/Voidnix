...
const SYSTEM_PROMPT: &str =
    "You are a translation engine. Translate the given text exactly. Output ONLY the translation. No explanations, notes, or conversational text.";

/// 默认翻译提示词模板（仅用于 user 消息）
